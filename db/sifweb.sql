...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2014 a las 00:01:50
...
--
ALTER TABLE `acumulainventario`
MODIFY `IdAcumulaInventario` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `det_compra`
MODIFY `id_deta_compra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
