		...
		<table align="center" width="400" border="0" cellspacing="5" cellpadding="3">
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="id_nit" id="id_nit" size="25" maxlength="11"  required="required" placeholder="N&uacute;mero" />
					
				</td>
            </tr>
            <tr>
                <td>
                    <input type="text" name="razon_social" id="razon_social" size="25" maxlength="30" required="required" placeholder="Raz&oacute;n Social" /> 
				</td>
                <td>
                    <input type="text" name="contacto" id="contacto" size="25" maxlength="30" required="required" placeholder="Contacto"/>
				</td>                    
            </tr>
            <tr>
                <td>
                    <input type="text" name="telefono_1" id="telefono_1" size="25" maxlength="20" required="required" placeholder="Tel&eacute;fono1" />
				</td>
                <td>
                    <input type="text" name="telefono_2" id="telefono_2" size="25" maxlength="20"  placeholder="Tel&eacute;fono2" />
				</td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="direccion" id="direccion" size="25" maxlength="30" required="required" placeholder="Direcci&oacute;n"/>
				</td>               
            </tr>
            <tr>
                <td colspan="2">                   
					<textarea name="observaciones" cols="60" maxlength="100" id="observaciones" placeholder="observaciones" ></textarea>
				</td>
            </tr>
            <tr>
